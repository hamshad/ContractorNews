                    ...
                    <div class="form-group">
                        <label for="category" class="col-form-label col-form-label-sm">Category</label>
                            <select class="form-control" name="category" id="search_cat">
                                ...
                                <option value="12" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '12'){ echo 'selected';}}?>>Veteran Business</option>
                                ...
                                <option value="41" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '41'){ echo 'selected';}}?>>Airports</option>
                                <option value="42" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '42'){ echo 'selected';}}?>>Bridges</option>
                                <option value="43" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '43'){ echo 'selected';}}?>>Housing and Urban Development</option>
                                <option value="44" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '44'){ echo 'selected';}}?>>Freeways and Highways</option>
                                <option value="45" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '45'){ echo 'selected';}}?>>Ports</option>
                                <option value="46" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '46'){ echo 'selected';}}?>>Procurement</option>
                                <option value="47" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '47'){ echo 'selected';}}?>>Public Works</option>
                                <option value="48" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '48'){ echo 'selected';}}?>>Railroads</option>
                                <option value="49" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '49'){ echo 'selected';}}?>>Schools</option>
                                <option value="50" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '50'){ echo 'selected';}}?>>Taxes and the IRS</option>
                                <option value="51" <?php if(!empty($data['search_data']['category'])){if($data['search_data']['category'] == '51'){ echo 'selected';}}?>>Treasury Department</option>-->
                            </select>
                      </div>
                </div>
                    ...
                    <div class="form-group">
                        <label for="keyword" class="col-form-label col-form-label-sm">Section</label>
                          <select class="form-control" name="section">
                              ...
                              <option value="cover story" <?php if(!empty($data['search_data']['section'])){if($data['search_data']['section'] == 'cover story'){ echo 'selected';}}?>>Cover Stories</option>
                              <option value="article" <?php if(!empty($data['search_data']['section'])){if($data['search_data']['section'] == 'article'){ echo 'selected';}}?>>Articles</option>
                              <option value="update" <?php if(!empty($data['search_data']['section'])){if($data['search_data']['section'] == 'update'){ echo 'selected';}}?>>Gov't Updates</option>
                          </select>
                      </div>
                </div>
                <div class="col-12 col-sm-12 col-md-3 col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="date" value="<?php if(!empty($data['search_data']['date'])){ echo $data['search_data']['date']; }?>" class="form-control" id="keyword" name="date">
                     </div>
                </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!--<td width="50%"><?php echo $value->description;?></td>-->
